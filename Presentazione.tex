...
variabili di \emph{blue}{link}: \[l_{i}=\sigma_{i}\; \sigma_{i+1}\; \sgn (J_i) \Longrightarrow {\sigma_{i+1}}=l_{i}\,\sigma_{i} \sgn (J_i)\qquad i\in\left\{ 1,\dots,L-1\right\}\]

gradi di libert\`a indipendenti: \[H=-\sum_{i} J_i l_{i}\]

generazione indipendente: \[p(l_i=+)=(1+e^{-2\beta |J_i|})^{-1}\]
