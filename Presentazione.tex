...
gradi di libert\`a indipendenti: \[H=-\sum_{i} J_i l_{i}\]
...
quando J non positivo? $\left\langle \sigma_{i}\,\sigma_{i+r}\right\rangle = 0$
...
\begin{itemize}
 ...
 \item se $J\in[-1,1]$, la possibilit\`a di $J=0$ cambia tutto: $L_{\xi}(\beta) \propto \beta$
\end{itemize}
...
\begin{itemize}
 ...
 \item Ricerca di un funzionale ``connesso'' per Ising 2D
\end{itemize}
